...
import { highlightStoreHook, sharedStore, useRemeasure, type Remeasure } from '../shared/highlight'
 ...
 */
export function useHighlightIndicator(container: ElementRef, indicator: ElementRef, options: HighlightIndicatorOptions = {}): Remeasure {
